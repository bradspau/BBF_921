...
from . import characteristic_specification_relationship_fvo
from . import characteristic_value_specification as characteristic_value_specification_1
...
class CharacteristicSpecificationFVO(Extensible):
    ...
    char_spec_relationship: Annotated[
        list[
            characteristic_specification_relationship_fvo.CharacteristicSpecificationRelationshipFVO
        ]
        | None,
    ...
    characteristic_value_specification: Annotated[
        list[characteristic_value_specification_1.CharacteristicValueSpecification]
        | None,
